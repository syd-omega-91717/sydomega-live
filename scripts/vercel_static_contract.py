...
def main() -> int:
    ...
    for marker in ("mkdir -p public", "public/index.html", "VERCEL_BUILD=PASS", "for dir in vendor i18n", "find vendor -type f", "public/${vendored}", "vendor files src=", "unreachable_asset=${ref}", "vercel-build-enhance.mjs"):
