...
.cstat{border:1px solid var(--border);background:var(--glass);padding:1rem 1.25rem;position:relative;overflow:hidden;text-decoration:none;display:block;transition:all .3s}
.cstat:hover{border-color:var(--gold);transform:translateY(-3px)}
...
.cstat-val{font-family:'Cinzel Decorative',serif;font-size:1.5rem;color:var(--gold);line-height:1}
...
.panel{background:var(--glass);border:1px solid var(--border);position:relative;overflow:hidden}
...
.panel-title{font-family:'Cinzel Decorative',serif;font-size:.82rem;color:var(--gold);letter-spacing:.1em}
...
.mod-link{display:flex;align-items:center;gap:.75rem;padding:.6rem .75rem;border:1px solid rgba(201,168,76,0.08);text-decoration:none;transition:all .2s}
...
.asc-track{display:grid;grid-template-columns:repeat(9,1fr);gap:.5rem;margin-top:.75rem}
...
<nav>
  <a href="index.html" class="nav-brand">&#937; SYDOMEGA</a>
  <ul class="nav-links">
    <li><a href="dashboard.html" class="active">Command</a></li>
  ...
  <div class="nav-right">
    <span class="nav-coord">COORD (9,9,9)</span>
...
<div class="page">
  ...
  <div class="hero">
    ...
    <h1 class="hero-title">Sovereign Command</h1>
    <p class="hero-sub">
      PLATFORM IDENTITY: OMEGA-91717-SYD-001<br>
      OWNER: MAJOR SLEIMAN YOUSSEF DAGHER<br>
      LEVEL: 9.9.9 // AUTHORITY: 15.588 // ALL-TIME ACCESS
    </p>
    <div class="hero-badges">
      <span class="hero-badge">ARIES // FIRE</span>
      <span class="hero-badge">OLYMPIAN: ARES</span>
      <span class="hero-badge">AGENT: SENTINEL</span>
      <span class="hero-badge">TOKEN: ARENITE</span>
      <span class="hero-badge">ENG. ORDER 30875</span>
    </div>
  </div>
  ...
  <div class="cmd-stats">
    <a href="matrix.html" class="cstat">
      ...
      <div class="cstat-val">729</div>
      <div class="cstat-sub">9x9x9 complete</div>
    </a>
    <a href="treasury.html" class="cstat">
      <div class="cstat-label">&#937; Supply</div>
      <div class="cstat-val">917B</div>
      <div class="cstat-sub">51% vault locked</div>
    </a>
    <a href="portfolio.html" class="cstat">
      <div class="cstat-label">Gold Reserve</div>
      <div class="cstat-val">412kg</div>
      <div class="cstat-sub">Auto-sweep active</div>
    </a>
    <a href="honors.html" class="cstat">
      <div class="cstat-label">Honors</div>
      <div class="cstat-val">48+</div>
      <div class="cstat-sub">Trophies / medals</div>
    </a>
    <a href="media.html" class="cstat">
      <div class="cstat-label">Media Titles</div>
      <div class="cstat-val">288</div>
      <div class="cstat-sub">Films + series + games</div>
    </a>
  ...
  <div class="cmd-grid">
    ...
    <div class="panel">
      <div class="panel-header">
        ...
        <span class="panel-badge">18 ACTIVE</span>
      </div>
      <div class="panel-body">
        <div class="module-links">
          <a href="dashboard.html" class="mod-link"><span class="mod-num">M01</span><span class="mod-name">Platform Core</span><span class="mod-arrow">&#8594;</span></a>
          <a href="#" class="mod-link"><span class="mod-num">M02</span><span class="mod-name">Consultancy Hub</span><span class="mod-arrow">&#8594;</span></a>
          <a href="#" class="mod-link"><span class="mod-num">M03</span><span class="mod-name">Gaming Layer</span><span class="mod-arrow">&#8594;</span></a>
          <a href="honors.html" class="mod-link"><span class="mod-num">M04</span><span class="mod-name">Achievement System</span><span class="mod-arrow">&#8594;</span></a>
          <a href="#" class="mod-link"><span class="mod-num">M05</span><span class="mod-name">Family System</span><span class="mod-arrow">&#8594;</span></a>
          <a href="media.html" class="mod-link"><span class="mod-num">M06</span><span class="mod-name">Media Universe</span><span class="mod-arrow">&#8594;</span></a>
          <a href="treasury.html" class="mod-link"><span class="mod-num">M07</span><span class="mod-name">Sovereign Vault</span><span class="mod-arrow">&#8594;</span></a>
          <a href="#" class="mod-link"><span class="mod-num">M08</span><span class="mod-name">Communication</span><span class="mod-arrow">&#8594;</span></a>
          <a href="#" class="mod-link"><span class="mod-num">M09</span><span class="mod-name">Horoscope Engine</span><span class="mod-arrow">&#8594;</span></a>
          <a href="#" class="mod-link"><span class="mod-num">M10</span><span class="mod-name">News Intelligence</span><span class="mod-arrow">&#8594;</span></a>
          <a href="#" class="mod-link"><span class="mod-num">M11-18</span><span class="mod-name">Heritage / Progress / AI...</span><span class="mod-arrow">&#8594;</span></a>
        </div>
      </div>
    </div>
    ...
    <div class="panel">
      <div class="panel-header">
        <span class="panel-title">System Feed</span>
        <span class="panel-badge">LIVE</span>
      </div>
      <div class="panel-body">
        <div class="sys-feed">
          <div class="feed-item"><div class="feed-dot ok"></div><div class="feed-text">Auto-sweep executed -- Gold / Silver / Rhodium acquired</div><div class="feed-time">09:00</div></div>
          <div class="feed-item"><div class="feed-dot ok"></div><div class="feed-text">Master Vault lock verified -- 51% &#937; sealed and confirmed</div><div class="feed-time">08:45</div></div>
          <div class="feed-item"><div class="feed-dot pend"></div><div class="feed-text">Polygon L2 activation gated -- legal clearance pending</div><div class="feed-time">07:30</div></div>
          <div class="feed-item"><div class="feed-dot ok"></div><div class="feed-text">ARENITE founder token genesis confirmed and logged</div><div class="feed-time">06:15</div></div>
          <div class="feed-item"><div class="feed-dot ok"></div><div class="feed-text">Media codex updated -- F-01 Myth of the Stones phase 1 active</div><div class="feed-time">05:00</div></div>
          <div class="feed-item"><div class="feed-dot warn"></div><div class="feed-text">KYC provider selection pending -- token economy gated</div><div class="feed-time">04:00</div></div>
          <div class="feed-item"><div class="feed-dot ok"></div><div class="feed-text">Matrix coordinate (9,9,9) confirmed -- authority 15.588</div><div class="feed-time">00:00</div></div>
          <div class="feed-item"><div class="feed-dot ok"></div><div class="feed-text">Engineers Order No.30875 hash verified on genesis block</div><div class="feed-time">GENESIS</div></div>
        </div>
      </div>
    </div>
  ...
  <div class="ascension">
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:1rem">
      <span style="font-family:'Cinzel Decorative',serif;font-size:.85rem;color:var(--gold);letter-spacing:.1em">9 Stages of Ascension</span>
      <span style="font-family:'Courier Prime',monospace;font-size:.65rem;color:var(--green)">STAGE 9 // APEX REACHED</span>
    </div>
    <div class="asc-track">
      <div class="asc-node done"><div class="asc-node-num">I</div><div class="asc-node-label">Initiate</div></div>
      <div class="asc-node done"><div class="asc-node-num">II</div><div class="asc-node-label">Learner</div></div>
      <div class="asc-node done"><div class="asc-node-num">III</div><div class="asc-node-label">Seeker</div></div>
      <div class="asc-node done"><div class="asc-node-num">IV</div><div class="asc-node-label">Builder</div></div>
      <div class="asc-node done"><div class="asc-node-num">V</div><div class="asc-node-label">Master</div></div>
      <div class="asc-node done"><div class="asc-node-num">VI</div><div class="asc-node-label">Architect</div></div>
      <div class="asc-node done"><div class="asc-node-num">VII</div><div class="asc-node-label">Sovereign</div></div>
      <div class="asc-node done"><div class="asc-node-num">VIII</div><div class="asc-node-label">Eternal</div></div>
      <div class="asc-node current"><div class="asc-node-num">IX</div><div class="asc-node-label">Omega</div></div>
    </div>
  </div>
</div>
