...
(function () {
  ...
  var CSS = [
    ...
    "#omg-chrono .lbl{opacity:.6;font-size:12px;letter-spacing:1.4px;text-transform:uppercase}",
    ...
    "#omg-chrono .state{margin-top:5px;font-size:12px;opacity:.55;letter-spacing:1px}",
