...
(function(){
  ...
  var PAGE_META = {
    ...
    principles:   {label:'Sovereign Principles',section:'IDENTITY', prev:'affirmations',   next:'journal'},
    ...
    fasting:      {label:'Sovereign Fasting',section:'WELLNESS',  prev:'workout',        next:'health'},
    vocabulary:   {label:'Sovereign Vocabulary',section:'MASTERY', prev:'reading',        next:'codex'},
