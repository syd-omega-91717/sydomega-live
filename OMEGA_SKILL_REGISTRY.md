...
| `supabase/migrations/*.sql` | 169 (106 numbered `NNNN_`, 63 timestamped) |
| Edge Functions | 11 |
| skills | 19 |
| agent definitions | 1 |
...
end-to-end for the first time"*. The 75 files added since (numbered and
timestamped alike) were **not part of that validation**, and no run has covered
all 169. Treat the validated scope as `0001`–`0094` only.
