...
(function(){
  ...
  function mountCinematicEngine(){loadScript('/omega-cinematic-engine.js','data-omega-cinematic',function(){EventBus.emit('cinematic_engine_loaded',{version:'1.1.0',page:_page});});EventBus.emit('cinematic_engine_ready',{version:'1.1.0',page:_page});}
  function mountApexVisual(){loadScript('/omega-apex-visual.js','data-omega-apex',function(){EventBus.emit('apex_visual_loaded',{version:'1.0.0',page:_page});});}
  mountVisualLayer();mountCinematicEngine();mountApexVisual();
