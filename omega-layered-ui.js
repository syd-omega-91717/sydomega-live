...
controls.innerHTML = '<button class=layer-btn data-show=1 style=font-family:var(--M);font-size:7px;letter-spacing:1.5px;padding:4px 10px;background:none;border:1px solid rgba(201,168,76,.2);color:var(--gold);border-radius:2px;cursor:pointer>◈ COMPREHEND</button>' + '<button class=layer-btn data-show=2 style=font-family:var(--M);font-size:7px;letter-spacing:1.5px;padding:4px 10px;background:none;border:1px solid rgba(201,168,76,.1);color:var(--muted);border-radius:2px;cursor:pointer>◉ EXPLORE</button>' + '<button class=layer-btn data-show=3 style=font-family:var(--M);font-size:7px;letter-spacing:1.5px;padding:4px 10px;background:none;border:1px solid rgba(201,168,76,.1);color:var(--muted);border-radius:2px;cursor:pointer>◎ DEEP</button>';
