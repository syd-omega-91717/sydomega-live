...
/* ── GEOMETRIC POLYGON SWEEP ────────────────────────────────────────────── */
@keyframes poly-spin-cw {
  from { transform: rotate(0deg) scale(1); }
  to { transform: rotate(360deg) scale(1); }
}

@keyframes poly-spin-ccw {
  from { transform: rotate(360deg) scale(1); }
  to { transform: rotate(0deg) scale(1); }
}

/* ── EMBLEM ORBITAL DANCE ──────────────────────────────────────────────── */
@keyframes emblem-orbit {
  0% { transform: translate(0, 0) scale(1); opacity: 1; }
  25% { transform: translate(12px, -8px) scale(1.08) rotateZ(90deg); }
  50% { transform: translate(0, 12px) scale(1); rotateZ(180deg); }
  75% { transform: translate(-12px, -8px) scale(1.08) rotateZ(270deg); }
  100% { transform: translate(0, 0) scale(1); rotateZ(360deg); opacity: 1; }
}

@keyframes emblem-pulse-glow {
  0%, 100% { filter: drop-shadow(0 0 8px rgba(201,168,76,.3)); transform: scale(1); }
  50% { filter: drop-shadow(0 0 24px rgba(201,168,76,.6)); transform: scale(1.12); }
}

@keyframes emblem-float-vertical {
...
@keyframes chromatic-shift {
  0% { filter: drop-shadow(0 0 12px rgba(201,168,76,.2)); }
  25% { filter: drop-shadow(2px 0 12px rgba(201,168,76,.3)) drop-shadow(-2px 0 12px rgba(0,229,255,.2)); }
  50% { filter: drop-shadow(0 0 12px rgba(0,229,255,.3)); }
  75% { filter: drop-shadow(-2px 0 12px rgba(201,168,76,.3)) drop-shadow(2px 0 12px rgba(0,229,255,.2)); }
  100% { filter: drop-shadow(0 0 12px rgba(201,168,76,.2)); }
}

/* ── LAYERED DEPTH CARDS ────────────────────────────────────────────────── */
@keyframes depth-layer-stack {
  0% { transform: translateZ(-60px) rotateX(8deg); opacity: 0.8; }
  50% { transform: translateZ(-30px) rotateX(4deg); opacity: 0.9; }
  100% { transform: translateZ(0px) rotateX(0deg); opacity: 1; }
}

@keyframes depth-layer-drift {
  0% { transform: translate(0, 0) translateZ(0); }
  25% { transform: translate(2%, 1%) translateZ(0); }
  50% { transform: translate(0, 2%) translateZ(0); }
  75% { transform: translate(-2%, 1%) translateZ(0); }
  100% { transform: translate(0, 0) translateZ(0); }
}

/* ── NEON GLOW PULSE ────────────────────────────────────────────────────– */
@keyframes neon-pulse {
  0%, 100% { box-shadow: 0 0 10px rgba(201,168,76,.3), inset 0 0 10px rgba(201,168,76,.1); }
  50% { box-shadow: 0 0 30px rgba(201,168,76,.6), inset 0 0 20px rgba(201,168,76,.2); }
}

@keyframes neon-pulse-cyan {
  0%, 100% { box-shadow: 0 0 10px rgba(0,229,255,.3), inset 0 0 10px rgba(0,229,255,.1); }
...
/* ── OPT-IN CINEMATIC CLASSES ──────────────────────────────────────────── */

/* For dashboard.html: geometric 3D cards */
.cinematic-card-3d {
  perspective: var(--persp);
  transform-style: preserve-3d;
}

.cinematic-card-3d:hover {
  animation: rotate-3d-z var(--rot-fast) linear alternate;
}

/* For profile.html and cosmos.html: emblem-centered glow */
.emblem-cinematic {
  position: relative;
  filter: drop-shadow(0 0 20px rgba(201,168,76,.4));
}

.emblem-cinematic:hover {
  animation: emblem-orbit var(--rot-med) cubic-bezier(.34,1.4,.64,1) infinite;
  filter: drop-shadow(0 0 40px rgba(201,168,76,.7));
}

/* Emblem with pulse glow */
.emblem-pulse {
  animation: emblem-pulse-glow 3s ease-in-out infinite;
}
...
.geometric-pattern {
  position: relative;
  background-image:
    linear-gradient(45deg, rgba(201,168,76,.05) 25%, transparent 25%),
    linear-gradient(-45deg, rgba(201,168,76,.05) 25%, transparent 25%),
    linear-gradient(45deg, transparent 75%, rgba(201,168,76,.05) 75%),
    linear-gradient(-45deg, transparent 75%, rgba(201,168,76,.05) 75%);
  background-size: var(--geo-size) var(--geo-size);
  background-position: 0 0, 0 calc(var(--geo-size)/2), calc(var(--geo-size)/2) calc(var(--geo-size)/-2), calc(var(--geo-size)/-2) 0px;
  animation: gvp-grid-sweep 12s linear infinite;
}
...
/* Futuristic scan effect overlay */
.scan-overlay::before {
  content: '';
  position: absolute;
  top: 0;
  ...
  right: 0;
  bottom: 0;
  background: linear-gradient(0deg, transparent 24%, rgba(0,229,255,.05) 25%, rgba(0,229,255,.05) 26%, transparent 27%, transparent 74%, rgba(0,229,255,.05) 75%, rgba(0,229,255,.05) 76%, transparent 77%, transparent);
...
/* Layered depth cards */
.depth-layer {
  animation: depth-layer-drift var(--rot-slow) ease-in-out infinite;
  perspective: var(--persp);
}
...
.gradient-mesh {
  ...
  animation: gradient-mesh-flow 15s ease infinite;
}
