/* Ω SYD OMEGA 91717 — CINEMATIC ENGINE v1.1
...
+'.omega-cine-depth{transform-style:preserve-3d;backface-visibility:hidden;background-image:radial-gradient(circle at var(--omega-lx,50%) var(--omega-ly,50%),var(--omega-depth-glow,rgba(0,229,255,0)),transparent 34%)!important;background-blend-mode:screen}'
