...
- **`visual-assets`** — Design or change any visual element of sydomega-live — SVG assets, sigils, emblems, share cards, QR, page marks, palette, typography — so it matches the…
