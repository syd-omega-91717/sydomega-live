...
(function(){
  ...
  var PS={
    ...
    ascension:'ascend',matrix:'ascend',sculpture:'cosmos',academy:'ascend',gaming:'ascend',
  ...
  var SECTIONS=[
    ...
    {key:'universe',icon:'\u25BA', label:'UNIVERSE', href:'/media.html',   col:'#C4453C',
  ...
  if(!document.getElementById('omega-mob')){
    ...
    var DRAWER_SECTIONS=[
      ...
      {icon:'\u25BA',label:'UNIVERSE',col:'#C4453C',href:'/media.html',key:'universe',
